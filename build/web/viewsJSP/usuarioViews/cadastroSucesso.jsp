            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-success" id="exampleModalLabel">Sucesso na requisicao</h5>

                    </div>
                    <div class="modal-body text-success">
                        Sucesso em seja la oque voce tentou!!
                        <br>
                        Agradeca o Erick imediatamente!!!
                    </div>
                    <div class="modal-footer d-flex justify-content-center">
                        <a href="/Trabalho_PI_2MA/" class="btn btn-primary">Ir para a pagina inicial</a>
                    </div>
                </div>
            </div>
        </div>
