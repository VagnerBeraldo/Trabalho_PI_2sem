    ...
    <section class="cadastro">
        ...
        <form action="${pageContext.request.contextPath}/usuario" method="POST">
            ...
            <fieldset class="preferencias">
                ...
                <input type="radio" name="curso_user" id="id-nodeJS" value="NODEJS">
                <label for="id-nodeJS">Node-Js</label> 

                <input type="radio" name="curso_user" id="id-Java" value="JAVA">
                <label for="id-Java">Java</label> 

                <input type="radio" name="curso_user" id="id-PHP" value="PHP">
